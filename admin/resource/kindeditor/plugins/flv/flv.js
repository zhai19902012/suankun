    ...
    self.plugin.flv = {
        edit: function () {
            ...
            //width
                            ...
                            '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="1000" maxlength="4" /> ',
                            '</div>',
            //height
                            '<div class="ke-dialog-row">',
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        var html = K.mediaImg(self.themesPath + 'common/blank.gif', {
                            src: '/Public/Plugins/kindeditor/plugins/flv/swf/Flvplayer.swf?vcastr_file=' + url,
